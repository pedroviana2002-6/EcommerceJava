...
*/
    ...
    public double calcularTotal() {
        ...
        double icms = 0;
        for (ItemCarrinho ic : itens) {
            icms = (ic.getQuantidade() * ic.getItem().getPreco() * 17) / 100;
            total += ic.getQuantidade() * ic.getItem().getPreco() + icms;
        }
        return total;
    }
    ...
    public void finalizarCompra(Loja loja) {
        ...
        this.cliente.getHistoricoCompras().registrarCompra(new Pedido());
